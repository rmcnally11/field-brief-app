  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="mt-1 font-heading text-4xl text-[color:var(--cream)]">Species</h1>
        <p className="mt-2 max-w-2xl text-sm text-[color:var(--cream)]/65">
          Doctrine from the Field Manual, limits from TPWD Outdoor Annual 2025–26 and FWC. Bahamas flats
          fish are treated as catch-and-release. Verify before you keep anything.
        </p>
      </div>
      <div className="grid gap-4">
        {SPECIES.map((s) => (
          <article key={s.id} className="rounded-2xl border border-[color:var(--line)] bg-[color:var(--panel)] p-5">
