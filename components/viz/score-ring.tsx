  ...
  return (
    <div className={cn("flex flex-col items-center", className)}>
      <svg width={size} height={size} viewBox="0 0 100 100" aria-label={`Score ${score.toFixed(1)} of 10`}>
        <circle cx="50" cy="50" r={r} fill="none" stroke="rgba(244,239,228,0.12)" strokeWidth="8" />
        <circle
          cx="50"
          cy="50"
          r={r}
        ...
        <text x="50" y="64" textAnchor="middle" fill="rgba(244,239,228,0.45)" fontSize="8" letterSpacing="1.4">
          OF 10
        </text>
      </svg>
      {label ? (
