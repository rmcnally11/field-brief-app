  ...
  return (
    <div className={cn("flex flex-col items-center", className)}>
      <svg width={size} height={size} viewBox="0 0 120 120" aria-label={has ? `Wind from ${cardinal ?? `${Math.round(dir)}°`}` : "No wind"}>
        <circle cx="60" cy="60" r="52" fill="rgba(18,32,44,0.55)" stroke="rgba(244,239,228,0.15)" />
        {ticks.map((deg) => {
        ...
        <circle cx="60" cy="60" r="18" fill="#12202c" stroke="rgba(244,239,228,0.2)" />
        ...
        <text x="60" y="70" textAnchor="middle" fill="rgba(244,239,228,0.5)" fontSize="7" letterSpacing="0.8">
          MPH
        </text>
      </svg>
