...
export const SPECIES: Species[] = [
  ...
  },
  {
    ...
    role: "primary",
    theaters: ["texas", "louisiana", "florida", "bahamas", "mexico"],
    peakMonths: [4, 5, 6, 7],
  ...
  },
  {
    ...
    latin: "Albula vulpes",
    role: "primary",
    theaters: ["florida", "bahamas", "mexico"],
  ...
  },
  {
    ...
    role: "bluewater",
    theaters: ["florida", "bahamas", "texas", "mexico"],
    peakMonths: [5, 6, 7, 8, 9],
    presentMonths: [4, 5, 6, 7, 8, 9, 10],
    tempMin: 70,
    tempMax: 88,
  ...
  },
  {
    ...
    why: "Eastern Pacific — Baja East Cape and La Paz, Costa Rica, Panama. Absent from Texas, Louisiana, the Keys, and the Bahamas. Lives on this atlas only on the Mexico Pacific desks.",
    regulation:
